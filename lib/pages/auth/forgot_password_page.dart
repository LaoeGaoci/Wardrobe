...
class _ForgotPasswordPageState extends State<ForgotPasswordPage> {
  ...
  Future<void> _sendCode() async {
    ...
    try {
       ...
       * “该邮箱已注册”之类的信息。
       */
      _showMessage(context.l10n.passwordResetCodeSent);
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      _showMessage(context.l10n.passwordResetSuccess);
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _InputLabel(label: l10n.newPassword),
                    ...
                    _InputLabel(label: l10n.confirmPassword),
